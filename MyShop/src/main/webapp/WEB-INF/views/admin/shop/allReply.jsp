...
<style>
	...
	.replyControl {text-align:right; padding:10px; }
	.replyControl button { border:2px solid #999; background:#fff; }
</style>
				...
				<c:forEach items="${reply}" var="reply">
					<li>
						<div class="replyInfo">
							...
							<p>
								<span>작성된 상품</span> <a href="/shop/view?n=${reply.gdsCode}">바로가기</a>
							</p>
						</div>
